      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Estamos prontos para ajudar sua empresa a crescer com soluções personalizadas.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-1/3">
            <div className="bg-blue-50 rounded-lg p-8 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:leonardobvieira@gmail.com" 
                      className="text-blue-600 hover:text-blue-800"
                    >
                      leonardobvieira@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-10">
                <h4 className="font-medium text-gray-800 mb-3">Siga-nos</h4>
          ...
          <div className="lg:w-2/3">
            <form onSubmit={handleSubmit} className="bg-white rounded-lg p-8 shadow-lg border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="md:col-span-2">
                  ...
                  >
                    ...
                    <option value="automacao">Automação Comercial para PMEs</option>
                    <option value="bi-farmacias">BI para Farmácias e Drogarias</option>
                    <option value="seguros">Seguros Data-Driven</option>
                    <option value="beautytech">BeautyTech Express</option>
